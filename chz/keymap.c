...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] =
{
  [_BASE] = LAYOUT_split_3x6_3(
    ...
    KC_CAPS_LOCK,   KC_Z,           KC_X,           KC_C,         KC_V,         KC_B,       KC_N,   KC_M,          KC_COMM,      KC_DOT,         KC_NO,   KC_NO,
                                    MO(_NUM),     KC_LSFT,      MO(_CMD),   KC_SPC, MO(_NAV),      KC_RSFT
  ),
  ...
  [_NAV] = LAYOUT_split_3x6_3(
     ...
     LGUI(LSFT(KC_T)),  KC_EXLM,            KC_AT,          KC_HASH,    KC_TILD,            KC_GRV,     LSFT(LGUI(KC_N)),   KC_BSLS,    TO(_MOUSE), KC_SLASH,     LGUI(KC_W),      TO(_ONEHAND),
